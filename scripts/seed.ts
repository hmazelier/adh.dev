...
import countries from '~/data/map/all-countries.json'
import { visitedCountries } from '~/json/visited-countries'
...
function seedVisitedCountries() {
  ...
  writeFileSync(`./json/countries.geojson`, JSON.stringify(countries))
}
